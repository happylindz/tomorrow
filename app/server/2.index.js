...
var _default = (_dec = Object(__WEBPACK_IMPORTED_MODULE_1_react_redux__["connect"])(mapStateToProps, mapDispatchToProps), _dec(_class = function (_PureComponent) {
  ...
  _createClass(_default, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      var url = nextProps.article.url;
      var nextUrl = nextProps.match.params.url;
      var state = nextProps.state;
      if (state === __WEBPACK_IMPORTED_MODULE_3__constants__["SUCCESS_STATE"] && url !== nextUrl) {
        this.props.fetchPostData({
...
(function () {
  ...
  reactHotLoader.register(mapStateToProps, 'mapStateToProps', '/Users/Mac/Desktop/tomorrow/client/container/article/index.jsx');
  reactHotLoader.register(mapDispatchToProps, 'mapDispatchToProps', '/Users/Mac/Desktop/tomorrow/client/container/article/index.jsx');
  leaveModule(module);
})();
...
(function () {
  ...
  reactHotLoader.register(_default, 'default', '/Users/Mac/Desktop/tomorrow/client/components/article/index.jsx');
  leaveModule(module);
})();
...
(function () {
  ...
  reactHotLoader.register(_default, 'default', '/Users/Mac/Desktop/tomorrow/client/components/skeleton-article/index.jsx');
  leaveModule(module);
})();
